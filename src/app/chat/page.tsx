  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? "block" : "hidden"}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-80 flex-col bg-gray-900 shadow-xl">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <button
              ...
              className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-white bg-gray-800 hover:bg-gray-700 rounded-lg mb-4 transition-colors"
            >
      ...
      {/* Desktop sidebar */}
      <div className="hidden lg:flex lg:w-80 lg:flex-col bg-gray-900">
              ...
              >
                <div className="flex items-center space-x-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500">{formatTime(conversation.lastUpdated)}</p>
                  </div>
                </div>
                <button
                  onClick={(e) => deleteConversation(conversation.id, e)}
